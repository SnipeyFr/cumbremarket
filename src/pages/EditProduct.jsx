...
export default function EditProduct() {
  ...
  React.useEffect(() => {
    setSEO({
      title: "Editar publicación | Equipo de montaña usado en Chile | Cumbre Market",
      description: "Actualiza los datos de tu equipo outdoor usado y mejora su visibilidad para compradores en Chile.",
      canonicalPath: "/EditProduct"
    });
  }, []);
  ...
  const updateMutation = useMutation({
    mutationFn: (data) => Product.update(productId, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['product', productId] });
      queryClient.invalidateQueries({ queryKey: ['my-products'] });
      setSuccess(true);
      setTimeout(() => navigate(createPageUrl('MyProducts')), 2000);
    },
  });
